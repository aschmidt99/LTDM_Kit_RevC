...
void flexpwm_sm1_isr() {
  ...
  //CH1
  if (context.ch[0].out >= 0.0) {
    FLEXPWM2_SM2VAL3 = FLEXPWM2_SM2VAL4 + fabs(context.ch[0].out)*(FLEXPWM2_SM2VAL1*1.0f);
    FLEXPWM2_SM2VAL5 = FLEXPWM2_SM2VAL4;
  } else if (context.ch[0].out < 0.0) {
    FLEXPWM2_SM2VAL3 = FLEXPWM2_SM2VAL4;
    FLEXPWM2_SM2VAL5 = FLEXPWM2_SM2VAL4 + fabs(context.ch[0].out)*(FLEXPWM2_SM2VAL1*1.0f);
  }
